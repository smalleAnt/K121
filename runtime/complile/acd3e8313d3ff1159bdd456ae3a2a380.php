...
<div class="page_main">
  ...
  {pboot:list num=6 order=sorting}
    <dl>
      <dd class="dl_img"><a href="[list:link]"><img src="[list:ico]" alt="[list:title]"></a></dd>
      <dt><a href="[list:link]" title="[list:title]">[list:title]</a></dt>
      <dd class="dl_txt"><a href="[list:link]" title="[list:title]">[list:description lencn=120]</a></dd>
    </dl>
    {/pboot:list} </div>
