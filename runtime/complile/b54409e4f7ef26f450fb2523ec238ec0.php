					  ...
					  <div class="layui-tab-content">
						...
						<div class="layui-tab-item ">
							  <div class="layui-form-item">
								  ...
								  <div class="layui-input-block">
									  <input type="text" name="model" value="<?php echo @$this->getVar('productExtInfo')->model;?>" placeholder="请输入型号" class="layui-input">
								  </div>
							  </div>
							  ...
							  <div class="layui-form-item">
								  ...
								  <div class="layui-input-block">
									  <input type="text" name="size" value="<?php echo @$this->getVar('productExtInfo')->size;?>" placeholder="请输入尺寸" class="layui-input">
								  </div>
							  </div>
							  ...
							  <div class="layui-form-item">
								  ...
								  <div class="layui-input-block">
									  <input type="text" name="resolution_ratio" value="<?php echo @$this->getVar('productExtInfo')->resolution_ratio;?>" placeholder="请输入分辨率" class="layui-input">
								  </div>
							  </div>

							  <div class="layui-form-item">
								  <label class="layui-form-label">视角</label>
								  <div class="layui-input-block">
									  <input type="text" name="view_angle" value="<?php echo @$this->getVar('productExtInfo')->view_angle;?>" placeholder="请输入视角" class="layui-input">
								  </div>
							  </div>
							  ...
							  <div class="layui-form-item">
								  ...
								  <div class="layui-input-block">
									  <input type="text" name="interface" value="<?php echo @$this->getVar('productExtInfo')->interface;?>" placeholder="请输入接口" class="layui-input">
								  </div>
							  </div>

							  <div class="layui-form-item">
								  <label class="layui-form-label">驱动IC</label>
								  <div class="layui-input-block">
									  <input type="text" name="ic" value="<?php echo @$this->getVar('productExtInfo')->ic;?>" placeholder="请输入驱动IC" class="layui-input">
								  </div>
							  </div>

							  <div class="layui-form-item">
								  <label class="layui-form-label">亮度(cd/m²)</label>
								  <div class="layui-input-block">
									  <input type="text" name="brightness" value="<?php echo @$this->getVar('productExtInfo')->brightness;?>" placeholder="请输入亮度" class="layui-input">
								  </div>
							  </div>

							  <div class="layui-form-item">
								  <label class="layui-form-label">触控屏</label>
								  <div class="layui-input-block">
									  <input type="text" name="touch_screen" value="<?php echo @$this->getVar('productExtInfo')->touch_screen;?>" placeholder="请输入触控屏" class="layui-input">
								  </div>
							  </div>

							  <div class="layui-form-item">
								  <label class="layui-form-label">控制板</label>
								  <div class="layui-input-block">
									  <input type="text" name="control_panel" value="<?php echo @$this->getVar('content')->control_panel;?>" placeholder="请输入控制板" class="layui-input">
								  </div>
							  </div>
...
<?php return array (
  0 => '/www/K121/apps/admin/view/default/common/head.html',
  1 => '/www/K121/apps/admin/view/default/common/ueditor.html',
  2 => '/www/K121/apps/admin/view/default/common/foot.html',
); ?>